    ...
    public class DatingRepository : IDatingRepository
    {
        ...
        public async Task<PagedList<Message>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            switch (messageParams.MessageContainer)
            {
                ...
                break;
                default:
                    messages = messages.Where(u => u.RecepientId == messageParams.UserId && u.RecepientDeleted==false && u.IsRead == false);
                break;
            }
        ...
        public async Task<IEnumerable<Message>> GetMessageThread(int userId, int recepientId)
        {
            ...
            .Include(u => u.Recepient)
            .ThenInclude(p => p.Photos)
            .Where(m => m.RecepientId == userId && m.RecepientDeleted == false && m.SenderId == recepientId || m.RecepientId == recepientId && m.SenderDeleted == false && m.SenderId == userId)
